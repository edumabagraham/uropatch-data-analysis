...
class GenerateFeatures:
    ...
    def create_summary_table(self):
        ...
        # All measures including new frequency domain features
        ...
        #             'spectral_skewness', 'spectral_kurtosis', 'alpha_band_power',
        #             'beta_band_power', 'gamma_band_power', 'relative_alpha_power',
        #             'relative_beta_power', 'relative_gamma_power', 'snr']  
        measures = ['permutation_entropy', 'spectral_entropy', 'mean', 'std', 
                    'range', 'rms', 'var', 'min', 'max', 'time_energy', 'spectral_energy', 
